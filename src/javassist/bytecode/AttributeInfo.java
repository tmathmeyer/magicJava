...
public class AttributeInfo {
    ...
    static AttributeInfo lookup(List<AttributeInfo> list, String name) {
        if (list == null)
            return null;
    ...
    static synchronized void remove(List<AttributeInfo> list, String name) {
        if (list == null)
            return;
    ...
    static void writeAll(List<AttributeInfo> list, DataOutputStream out)
        throws IOException
    {
        if (list == null)
            return;
    ...
    static List<AttributeInfo> copyAll(List<AttributeInfo> list, ConstPool cp) {
        if (list == null)
            return null;
